...
describe("Treemap", function () {
    ...
    it('should load a normal report w/ the treemap visualization correctly', function (done) {
        expect.screenshot('normal_treemap').to.be.captureSelector('.pageWrap', function (page) {
            page.load(normalUrl);
    ...
    it('should load a report directly as treemap visualization correctly', function (done) {
        expect.screenshot('initial_treemap').to.be.captureSelector('.pageWrap', function (page) {
